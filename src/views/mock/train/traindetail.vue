<template>
    <div class="wrap">
        ...
        <div class="message">
            ...
            <div class="message-container">
                ...
                <div class="message-right">
                    <div class="lists">
                        <el-button
                            v-show="getJurisdiction('close:class')"
                            :disabled="closeraction" :style="{backgroundColor:status==='31'||status==='30'?'#ccc':'#4856DD'}" icon="el-icon-lock"
                    ...
                    <div class="lists">
                        <el-button
                            v-show="getJurisdiction('report:class')"
                            :disabled="diss" :style="{backgroundColor:diss===true?'#ccc':'#4856DD'}" icon="el-icon-reading" type="primary"
                            @click="action()"
                        >{{ dname ?'已报到':'报到' }}
                        </el-button>
                    </div>
        ...
        <div class="train">
            ...
            <!--        闭班-->
            <el-dialog :visible.sync="closeClass" append-to-body width="30%">
                <div class="selection">
                    <el-select v-model="dictValue" placeholder="请选择" style="width: 100%" @change="TaskArr">
                        <el-option v-for="item in resonlist" :key="item.dictValue" :label="item.dictLabel" :value="item.dictLabel" />
                    </el-select>
                </div>
                <!--                文本域-->
                <el-input
                    v-if="trigger_typeshow"
                    v-model="remark"
                    :rows="2"
                    maxlength="200"
                    placeholder="请输入内容"
        ...
        <div class="resource">
            ...
            <div class="resource-container">
                <table1 ref="table1" class="table1" :status="status" :sign-up="signUp" :check="check" />
            </div>
        </div>
        <!-- tab栏切换 -->
        <div class="tabs">
            <tabs ref="Tabs" :detail="messager" />
        </div>
    </div>
</template>
<script>
