<template>
    <div class="train-retrieval">
        ...
        <basic-table :columns="columns" :data="trainList" @selection-change="handleSelectionChange">
            <el-table-column align="left" label="培训标题" prop="trainTitle" width="180px" />
            ...
            <el-table-column align="left" label="操作" width="180px">
                <template #default="{ row }">
                    <el-button v-if="getJurisdiction('train:detail')" icon="el-icon-connection" size="mini" type="text" @click="Detail(row.id)">详情
                    </el-button>
                </template>
            </el-table-column>
        </basic-table>
